  ...
  return (
    <div className={style.container}>
          ...
          <>
            <div className={style.left}>
              <div className={style.centerImg}>
                <img src={dish.img} className={style.img} />
              </div>
            </div>
              ...
              <div className={style.info}>
                ...
                {compound ? (
                  <div className={style.compound}>
                    <b>Состав: </b>
                    {compound.map((i) => (
                      <span className={style.compoundItem} key={i}>
                        {i},{' '}
                      </span>
                    ))}{' '}
                  </div>
      ...
      <div className={style.order}>
        <div className={style.deliv}>
          <b>Доставка в течении 1 часа*</b>
        </div>
